          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4 pt-12 text-left">
              <h2 className="text-2xl font-black leading-tight tracking-tight text-slate-900">
                Platform Administrative Control Panel
              </h2>
              <p className="text-xs text-slate-500 leading-relaxed">
                Superuser console for managing registered platform users, database role audits, and catalog course moderation.
              </p>
            </div>
          </div>
